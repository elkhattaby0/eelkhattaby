...
const Footer = () => {
    return (
        <section className="bg-[#212121] w-full h-screen max-lg:h-fit max-md:h-fit max-sm:h-fit flex justify-center">
            <div data-aos="flip-up" className="max-lg:h-fit max-md:h-fit max-sm:h-fit w-[85%] py-[2%] flex flex-col justify-between border-  max-lg:my-[2%]">
                <span className='font-semibold w-full h-2/5 flex items-center max-lg:flex-col max-lg:h-1/3 '>
                    <div className="p-[20px] w-2/5 m-[15px] border-2 max-lg:m-[0px] h-4/5 flex flex-col justify-between max-lg:h-[40%] max-lg:w-full max-lg:h-[200px]">
                ...
                <span className="text-[#f5f5f5] max-lg:flex max-lg:felx-col max-lg:h-1/3">
                    ...
                    <span className="flex justify-between font-semibold items-center border- mt-[10px] max-lg:flex-col max-lg:w-full">
                        ...
                        <button className="flex items-center hover:text-[#ffb646]" onClick={()=> {
                            ...
                            <p>Back to Top</p>
                            <img width="24" src="https://img.icons8.com/sf-black-filled/64/FFFFFF/up.png" alt="up"/>
                        </button>
                    </span>
                </span>
            </div>
